...
public final class KNPCModule implements GameModule {

	public static final Logger _LOGGER = KGameLogger.getLogger(KNPCModule.class);

	public static KNPCModule instance;

	private String _moduleName;
	private int _msgLowerId;
	private int _msgUpperId;
	private KNPCModuleExtension extension;
	...
	public void init(String cfgPath, String pModuleName, int pMsgLowerId, int pMsgUpperId) throws Exception {
		...
		extension = (KNPCModuleExtension) Class.forName(className).newInstance();
		//
	...
	public KNPCModuleExtension getExtension() {
		return extension;
	}
