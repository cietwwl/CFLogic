...
public final class KRankModule implements GameModule {

	public static final Logger _LOGGER = KGameLogger.getLogger(KRankModule.class);

	public static KRankModule instance;

	private String _moduleName;
	private int _msgLowerId;
	private int _msgUpperId;
	private KRankModuleExtension extension;
	...
	public void init(String cfgPath, String pModuleName, int pMsgLowerId, int pMsgUpperId) throws Exception {
		...
		extension = (KRankModuleExtension) Class.forName(className).newInstance();
		//
	...
	public KRankModuleExtension getExtension() {
		return extension;
	}
