...
import com.kola.kmp.logic.level.petcopy.KPetCopyActivity;
...
public class KFriendCopyActivity extends KActivity {

	private static KFriendCopyActivity instance;

	public static KFriendCopyActivity getInstance() {
		return instance;
	}

	public KFriendCopyActivity() {
		super();
		instance = this;
		this.isOpened = true;
	}
	...
	public KActionResult playerRoleJoinActivity(KRole role) {
		...
		KNPCOrderMsg.sendNPCMenuOrder(role,
				KNPCOrderEnum.ORDER_OPEN_FRIEND_COPY,
	...
	public int getRestJoinActivityCount(KRole role) {
		...
		int remainCount = KFriendCopyManager.free_challenge_count;
		if (record != null) {
