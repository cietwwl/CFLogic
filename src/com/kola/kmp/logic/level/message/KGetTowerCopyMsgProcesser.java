...
import static com.kola.kmp.protocol.level.KLevelProtocol.CM_GET_TOWER_COPY_DATA;
...
public class KGetTowerCopyMsgProcesser implements GameMessageProcesser {

	@Override
	public GameMessageProcesser newInstance() {
		return new KGetTowerCopyMsgProcesser();
	}

	@Override
	public int getMsgIdHandled() {
		return CM_GET_TOWER_COPY_DATA;
	}
