...
public final class KFashionModule implements GameModule {

	public static final Logger _LOGGER = KGameLogger.getLogger(KFashionModule.class);

	public static KFashionModule instance;

	private String _moduleName;
	private int _msgLowerId;
	private int _msgUpperId;
	private KFashionModuleExtension extension;

	public KFashionModule() {
		instance = this;
	}
	...
	public void init(String cfgPath, String pModuleName, int pMsgLowerId, int pMsgUpperId) throws Exception {
		...
		extension = (KFashionModuleExtension) Class.forName(className).newInstance();
		//
	...
	public KFashionModuleExtension getExtension() {
		return extension;
	}
