...
public class KGrwSynWarInfosMsg implements KGangResWarProtocol {

	public static void pushMsg(ResWarCity city) {
		KGameMessage backMsg = KGame.newLogicMessage(SM_GANGRW_SYN_CITY_WARINFO);
		KResWarMsgPackCenter.packCityWarInfo(backMsg, city);
		// 向城市对战军团成员发送
