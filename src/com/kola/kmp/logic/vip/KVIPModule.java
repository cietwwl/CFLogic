...
public final class KVIPModule implements GameModule {

	public static final Logger _LOGGER = KGameLogger.getLogger(KVIPModule.class);

	public static KVIPModule instance;

	private String _moduleName;
	private int _msgLowerId;
	private int _msgUpperId;
	private KVIPModuleExtension extension;
	...
	public void init(String cfgPath, String pModuleName, int pMsgLowerId, int pMsgUpperId) throws Exception {
		...
		extension = (KVIPModuleExtension) Class.forName(className).newInstance();
		//
	...
	public KVIPModuleExtension getExtension() {
		return extension;
	}
