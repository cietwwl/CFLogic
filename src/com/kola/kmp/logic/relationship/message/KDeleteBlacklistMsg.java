...
public class KDeleteBlacklistMsg implements GameMessageProcesser, KRelationShipProtocol {

	@Override
	public GameMessageProcesser newInstance() {
		return new KDeleteBlacklistMsg();
	}

	@Override
	public int getMsgIdHandled() {
		return CM_DELETE_BLACKLIST;
	}
	...
	public void processMessage(KGameMessageEvent msgEvent) throws Exception {
		...
		RSResult_AddFriend result = KRelationShipLogic.dealMsg_deleteBlackList(role, oppRoleId);
		// -------------
