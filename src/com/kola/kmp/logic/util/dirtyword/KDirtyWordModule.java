...
public final class KDirtyWordModule implements GameModule {

	public static final Logger _LOGGER = KGameLogger.getLogger(KDirtyWordModule.class);

	public static KDirtyWordModule instance;

	private String _moduleName;
	private int _msgLowerId;
	private int _msgUpperId;
	private KDirtyModuleExtension extension;

	public KDirtyWordModule() {
		instance = this;
	}
	...
	public void init(String cfgPath, String pModuleName, int pMsgLowerId, int pMsgUpperId) throws Exception {
		...
		extension = (KDirtyModuleExtension) Class.forName(className).newInstance();
		//
	...
	public KDirtyModuleExtension getExtension() {
		return extension;
	}
