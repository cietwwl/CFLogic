...
import com.kola.kgame.cache.mail.MailModule;
import com.kola.kgame.cache.mail.impl.KAMailModuleExtension;
import com.kola.kgame.cache.mail.impl.KMailModule;

public class KMailModuleExtension extends KAMailModuleExtension {

	public void init(MailModule module, String cfgPath) throws Exception {
	...
	public void notifyCacheLoadComplete() {
		...
		MailTaskManager.notifyCacheLoadComplete();
	...
	public KMailSet newMailSet(long roleId, boolean isFirstNew) {
		return new KMailSet(roleId, isFirstNew);
	}

	public static KMailSet getMailSet(long roleId) {
		return (KMailSet) KMailModule.instance.getMailSet(roleId);
	}
}
