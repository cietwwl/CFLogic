...
public class KJoinMineralMsg implements GameMessageProcesser, KActivityProtocol {

	@Override
	public GameMessageProcesser newInstance() {
		return new KJoinMineralMsg();
	}

	@Override
	public int getMsgIdHandled() {
		return CM_JOIN_MINERAL;
	}
	...
	public void processMessage(KGameMessageEvent msgEvent) throws Exception {
		...
		CommonResult result = KDigMineralActivityManager.dealMsg_joinMineral(role);
