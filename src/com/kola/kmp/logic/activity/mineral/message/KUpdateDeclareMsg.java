...
public class KUpdateDeclareMsg implements GameMessageProcesser, KActivityProtocol {

	@Override
	public GameMessageProcesser newInstance() {
		return new KUpdateDeclareMsg();
	}

	@Override
	public int getMsgIdHandled() {
		return CM_REQUEST_CHANGE_SIGN;
	}
	...
	public void processMessage(KGameMessageEvent msgEvent) throws Exception {
		...
		CommonResult result = KDigMineralActivityManager.dealMsg_updateDeclare(role, data);
