...
public class KGoBackTownMsg implements GameMessageProcesser, KActivityProtocol {

	@Override
	public GameMessageProcesser newInstance() {
		return new KGoBackTownMsg();
	}

	@Override
	public int getMsgIdHandled() {
		return CM_REQUEST_RETURN_MAIN_SCENE;
	}
	...
	public void processMessage(KGameMessageEvent msgEvent) throws Exception {
		...
		CommonResult result = KDigMineralActivityManager.dealMsg_gobackTown(role);
